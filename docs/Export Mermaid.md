...
The following C4 context diagram shows how the **Export Mermaid Diagram** command interacts with Autodesk Fusion 360 and external rendering tools.
...
C4Context
    ...
    System(addin, "Power Tools – Export Mermaid", "Fusion 360 add-in command that traverses the component hierarchy and writes a Mermaid flowchart file.")
